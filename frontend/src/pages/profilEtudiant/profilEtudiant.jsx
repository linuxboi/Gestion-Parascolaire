...
const Profil = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        const response = await axios.get("https://gestion-parascolaire.onrender.com/api/profil", {
  ...
  const handleUpdatePassword = async (e) => {
    ...
    try {
      ...
      const response = await axios.put(
        "https://gestion-parascolaire.onrender.com/api/profil/updatePassword",
        {
          motDePasseActuel,
          nouveauMotDePasse,
        },
  ...
  const handleProfilePicUpload = async (e) => {
    ...
    try {
      const token = localStorage.getItem("token");
      const response = await axios.put(
        "https://gestion-parascolaire.onrender.com/api/profil/upload",
        formData,
        {
          headers: {
